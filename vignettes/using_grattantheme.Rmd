...
set_overleaf_project("Orange")  # Searches for matching project name
...
The function saves only the PDF version of your chart to the atlas folder. No PowerPoint or data files are created. You can still specify chart types:
```{r, eval = FALSE}
