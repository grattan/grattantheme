...
#'
#' Note that you will also need to modify the colour scheme (using grattan_pal), save your object at the appropriate size (using grattan_save), and most likely make some manual modifications to the theme (such as legend.position = "none).
#'
