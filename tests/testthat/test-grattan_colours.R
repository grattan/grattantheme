...
test_that("grattan colour functions work as expected", {
  ...
  expect_length(grattan_pal(), 6)
  expect_length(grattan_pal(faded_level = 1), 6)
  expect_length(grattan_pal(faded_level = 2), 6)
  expect_length(grattan_pal(faded_level = 3), 6)
  expect_length(grattan_pal(faded_level = 4), 6)
  expect_length(grattan_pal(faded_level = 5), 6)
  expect_length(grattan_pal(faded_level = 6), 6)
  expect_length(grattan_pal(faded_level = 7), 6)
  expect_length(grattan_pal(faded_level = 8), 6)
